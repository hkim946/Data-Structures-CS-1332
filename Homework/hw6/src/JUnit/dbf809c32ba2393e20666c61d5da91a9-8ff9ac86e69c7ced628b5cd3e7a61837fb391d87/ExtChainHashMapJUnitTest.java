...
public class ExtChainHashMapJUnitTest {
    ...
    @Test(timeout = TIMEOUT)
    public void addNegativeKeyWithResize() {
        Integer[] keysToAdd = {3,4,1,2,7,6,5,10,9,8,13,12,11}; //resize occurred since load factor was exceeded
        String[] valuesToAdd = {"B", "A", "F", "D", "C", "L", "G", "M", "J", "I", "K", "E", "H"};
        for (int i = 0; i < keysToAdd.length; i++) {
            assertNull(hashMap.put(keysToAdd[i], valuesToAdd[i]));
    ...
    @Test(timeout = TIMEOUT)
    public void addAnEntryThatHasMinValKey() {
        assertNull(hashMap.put(0, "A"));
        assertNull(hashMap.put(1, "B"));
        assertNull(hashMap.put(2, "C"));
        assertNull(hashMap.put(3, "D"));
        ...
        assertNull(hashMap.put(5, "F"));
        assertNull(hashMap.put(6, "G"));
        assertNull(hashMap.put(Integer.MIN_VALUE, "H"));
        List<String> expectedValues = new ArrayList<>();
        expectedValues.add("A");
        expectedValues.add("B");
        expectedValues.add("C");
        ...
        expectedKeys.add(5);
        expectedKeys.add(6);
        expectedKeys.add(Integer.MIN_VALUE);
        assertEquals(expectedKeys, hashMap.keySet());
    }
    //////////////////////////////////
    //remove test
    ...
    @Test(timeout = TIMEOUT)
    public void removeWithCollisionFromHead() {
        assertNull(hashMap.put(0,  "A"));
        assertNull(hashMap.put(13, "B"));
        assertNull(hashMap.put(26, "C"));
        assertNull(hashMap.put(39, "D"));
        assertNull(hashMap.put(52, "E")); //E -> D -> C -> B -> A
        assertEquals("E", hashMap.remove(52));
        assertEquals(4, hashMap.size());
        ArrayList<String> expectedVals = new ArrayList<>();
        expectedVals.add("D");
        expectedVals.add("C");
    ...
    @Test(timeout = TIMEOUT)
    public void removeCollisionInChain() {
        assertNull(hashMap.put(0,  "A"));
        assertNull(hashMap.put(13, "B"));
        assertNull(hashMap.put(26, "C"));
        assertNull(hashMap.put(39, "D"));
    ...
    @Test(timeout = TIMEOUT)
    public void removeAnEntryWithNegativeKey() {
        assertNull(hashMap.put(0,  "A"));
        assertNull(hashMap.put(-13, "B"));
        assertNull(hashMap.put(26, "C"));
        assertNull(hashMap.put(-39, "D"));
        assertNull(hashMap.put(52, "E")); //E -> D -> C -> B -> A
        assertEquals("B", hashMap.remove(-13));
        assertEquals(4, hashMap.size());
        ArrayList<String> expectedVals = new ArrayList<>();
        expectedVals.add("E");
        expectedVals.add("D");
    ...
    @Test(timeout = TIMEOUT)
    public void getNegativeKey() {
        assertNull(hashMap.put(0,  "A"));
        assertNull(hashMap.put(-13, "B"));
        assertNull(hashMap.put(26, "C"));
        assertNull(hashMap.put(-39, "D"));
        assertNull(hashMap.put(52, "E")); //E -> D -> C -> B -> A
        assertEquals("D", hashMap.get(-39));
    }
    @Test(expected = NoSuchElementException.class, timeout = TIMEOUT)
    ...
    @Test(timeout = TIMEOUT)
    public void containsANegativeKey() {
        assertNull(hashMap.put(0,  "A"));
        assertNull(hashMap.put(-13, "B"));
        assertNull(hashMap.put(26, "C"));
        assertNull(hashMap.put(-39, "D"));
        ...
        assertFalse(hashMap.containsKey(-65));
    }
    @Test(timeout = TIMEOUT)
    ...
    public void badResize2() {
        Integer[] keysToAdd = {3,    13,  16,   6,  26,  30,   6,   12,   47}; //resize doesn't occur bc of duplicate element
        String[] valuesToAdd = {"B", "B", "F", "D", "M", "L", "G", "M",  "I"};
        for (int i = 0; i < keysToAdd.length; i++) {
            hashMap.put(keysToAdd[i], valuesToAdd[i]);
        }
    ...
    @Test(timeout = TIMEOUT)
    public void resizeByDoubling() {
        assertNull(hashMap.put(0, "H"));
        assertNull(hashMap.put(1, "A"));
        assertNull(hashMap.put(2, "P"));
        assertNull(hashMap.put(3, "P"));
        assertNull(hashMap.put(4, "Y"));
        assertEquals(5, hashMap.size());
        hashMap.resizeBackingTable(hashMap.size() * 2);
        ExternalChainingMapEntry<Integer, String>[] expected =
                (ExternalChainingMapEntry<Integer, String>[])
                        new ExternalChainingMapEntry[10];
        expected[0] = new ExternalChainingMapEntry<>(0, "H");
        expected[1] = new ExternalChainingMapEntry<>(1, "A");
        expected[2] = new ExternalChainingMapEntry<>(2, "P");
        expected[3] = new ExternalChainingMapEntry<>(3, "P");
        expected[4] = new ExternalChainingMapEntry<>(4, "Y");
        assertArrayEquals(expected, hashMap.getTable());
    }
    @Test(timeout = TIMEOUT)
    public void resizeWithCollisions() {
        ...
        assertEquals(8, hashMap.size());
        assertEquals(13, hashMap.getTable().length);
        hashMap.resizeBackingTable(8);
    }
    @Test(expected = IllegalArgumentException.class, timeout = TIMEOUT)
    public void resizeWithCollisionsFail() {
        Integer[] keysToAdd = {3,    13,  16,   6,  26,  30,   6,   12,   47}; //resize doesn't occur bc of duplicate element
        String[] valuesToAdd = {"B", "B", "F", "D", "M", "L", "G", "M",  "I"};
        for (int i = 0; i < keysToAdd.length; i++) {
            hashMap.put(keysToAdd[i], valuesToAdd[i]);
