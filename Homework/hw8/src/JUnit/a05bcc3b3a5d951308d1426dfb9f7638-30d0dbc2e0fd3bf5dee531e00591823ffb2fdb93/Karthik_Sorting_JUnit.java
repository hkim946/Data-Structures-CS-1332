...
public class Karthik_Sorting_JUnit {
    ...
    @Test(timeout = TIMEOUT)
    public void lsdRadixSizeOneList() {
        int[] unsortedArray = new int[] {3};
    ...
    @Test(timeout = TIMEOUT)
    public void lsdRadixIntegerMinValue() {
        int[] unsortedArray = new int[] {393239,12324,3467,2354,5675867,Integer.MIN_VALUE, 123123};
        int[] sortedArray = new int[] {Integer.MIN_VALUE, 2354, 3467, 12324, 123123, 393239, 5675867};
        Sorting.lsdRadixSort(unsortedArray);
        assertArrayEquals(sortedArray, unsortedArray);
    }
    @Test(timeout = TIMEOUT)
    public void lsdRadixIntegerMinValueAllNegatives() {
        int[] unsortedArray = new int[] {-393239, -12324, -3467, -2354, -5675867, Integer.MIN_VALUE, -123123};
        int[] sortedArray = new int[] {Integer.MIN_VALUE, -5675867, -393239, -123123, -12324, -3467, -2354};
        Sorting.lsdRadixSort(unsortedArray);
        assertArrayEquals(sortedArray, unsortedArray);
    }
    @Test(timeout = TIMEOUT)
    public void lsdRadixIntegerMinValueTwo() {
        int[] unsortedArray = new int[] {-3,-5,-7,-1,-2, Integer.MIN_VALUE, -6};
        int[] sortedArray = new int[] {Integer.MIN_VALUE, -7,-6,-5,-3,-2,-1};
        Sorting.lsdRadixSort(unsortedArray);
        assertArrayEquals(sortedArray, unsortedArray);
    }
    @Test(timeout = TIMEOUT)
    public void lsdRadixAllZeroes() {
